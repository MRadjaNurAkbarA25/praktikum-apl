                ...
                if (dataUser[indexUser].role == "admin") {
                    while (true) {
                        ...
                        switch(pilihanAdmin) {
                            case 1: {
                                while (true) {
                                    string opsiPenduduk[] = {"Lihat", "Tambah", "Edit", "Hapus", "Urut Nama Penduduk (Desc)", "Kembali"};
                                    int pilihanPenduduk = tampilMenu("Menu Penduduk", opsiPenduduk, 6);
                                    cin.ignore();
                            ...
                            case 3: {
                                while (true) {
                                    string opsiSurat[] = {"Lihat", "Update", "Hapus", "Urut ID Surat (Asc)", "Urut Status Surat (Asc)", "Kembali"};
                                    int pilihanSurat = tampilMenu("Menu Surat", opsiSurat, 6);
                                    cin.ignore();
                                    switch(pilihanSurat) {
                    ...
                    while (true) {
                        ...
                        switch(pilihanUser) {
                            ...
                            case 3: {
                                while (true) {
                                    string opsiSuratUser[] = {"Lihat Surat", "Buat Surat", "Edit Surat", "Hapus Surat", "Urut Status Surat (Ascs)", "Kembali"};
                                    int pilihanSuratUser = tampilMenu("Menu surat", opsiSuratUser, 6);
                                    cin.ignore();
